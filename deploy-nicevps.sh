...
#  Run ON the new NiceVPS server as root
# ═══════════════════════════════════════════════════════
...
echo ""
echo "  ⚠ SAVE THESE NOW — not shown again"
echo ""
echo "  NEXT:"
echo "  1. DNS: ${DOMAIN} A → ${IP}"
echo "  2. scp -r root@139.59.247.131:/root/aegis/aegis-build/* /opt/aegis/"
echo "  3. cd /opt/aegis && chown -R aegis:aegis ."
echo "  4. su aegis -c 'cd /opt/aegis && pnpm install && node scripts/seed-operators.mjs && pnpm build'"
