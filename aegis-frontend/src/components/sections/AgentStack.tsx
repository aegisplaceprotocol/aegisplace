...
const STACK: StackLayer[] = [
  ...
  },
  {
    ...
    desc: "Bonded validation, on-chain reputation, slashing, insurance, and dispute resolution. The layer that answers: should I use this operator? ERC-8004 defined identity but explicitly left validation as 'a design space.' Aegis fills that gap.",
    isAegis: true,
    stats: "The missing layer",
  },
  {
    id: "payment",
    label: "PAYMENT",
  ...
  },
  {
    ...
    status: "LIVE",
    statusColor: "text-zinc-300/80",
    desc: "On-chain settlement for payments, bonds, and reputation. Solana: 400ms finality, $0.00025/tx, 4K TPS. Token-2022 transfer hooks enforce bonds at the protocol level.",
    isAegis: false,
