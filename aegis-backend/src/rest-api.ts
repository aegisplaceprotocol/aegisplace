...
function formatOperator(op: Record<string, unknown>) {
  ...
  return {
    ...
    totalEarnings: op.totalEarnings || "0",
    healthStatus: op.healthStatus || "healthy",
    health: op.healthStatus || "healthy",
    hasPrivateSkill,
    ...
    isVerified: Boolean(op.isVerified),
