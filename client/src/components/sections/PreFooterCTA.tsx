      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        <motion.div {...fadeInView} className="relative overflow-hidden rounded border border-zinc-800" style={{ padding: '64px 32px' }}>
          ...
          <div className="relative z-10 text-center">
            <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-normal text-white leading-[1.05] tracking-tight mb-6">
              Upload your skill.
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <a
                href="/docs"
                className="inline-flex items-center gap-2 text-[14px] font-medium text-zinc-300/70 hover:text-zinc-300 border border-white/[0.04] hover:border-white/[0.08] px-8 py-3.5 rounded transition-all duration-300 hover:bg-white/[0.04]"
              >
                Read the Docs
              </a>
            </div>
            ...
            <div className="flex items-center justify-center gap-4 mt-12">
              <a href="#" className="flex items-center gap-2 px-4 py-2.5 border border-white/[0.04] rounded hover:border-white/[0.08] transition-all text-white/25 hover:text-white/50">
