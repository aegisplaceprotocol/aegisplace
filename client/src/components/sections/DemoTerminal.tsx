...
const LINES: { type: string; text: string; delay?: number }[] = [
  ...
  { type: "split-detail", text: "    -> 7.44 $AEGIS  (60%)  -> creator:  9pLm...kQ4w" },
  { type: "split-detail", text: "    -> 1.86 $AEGIS  (15%)  -> validators: 3xNr...jP8v" },
  { type: "split-detail", text: "    -> 1.49 $AEGIS  (12%)  -> stakers pool" },
  { type: "split-detail", text: "    -> 0.99 $AEGIS  ( 8%)  -> protocol treasury" },
  { type: "split-detail", text: "    -> 0.37 $AEGIS  ( 3%)  -> insurance fund" },
  { type: "split-detail", text: "    -> 0.25 $AEGIS  ( 2%)  -> burned (deflationary)" },
  { type: "blank", text: "" },
  ...
  { type: "dim", text: "  Compatible: Claude Code \u00b7 Claude Cowork \u00b7 Codex CLI \u00b7 Codex App \u00b7 ChatGPT" },
  { type: "dim", text: "  Claude Remote Control: monitor invocations from mobile" },
  { type: "blank", text: "" },
