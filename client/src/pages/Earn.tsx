...
function EarningsCalculator() {
  ...
  return (
    <div className="border border-white/[0.07] bg-white/[0.015]">
      <div className="p-6 sm:p-8 lg:p-10 border-b border-white/[0.07]">
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="font-medium text-[15px] text-zinc-300 font-bold">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.06]">
        {[
          ...
          <div key={item.label} className="bg-white/[0.02] p-4 sm:p-6">
            ...
            <div className="text-[22px] sm:text-[28px] font-bold text-zinc-300 tracking-tight leading-none">
      ...
      {/* Breakdown */}
      <div className="p-4 sm:p-6 border-t border-white/[0.07] flex flex-wrap gap-6 text-[12px] text-white/25">
    ...
    <div>
      ...
      <div className="space-y-0">
        {steps.map((step, i) => (
          <div
            key={step.number}
            className={`relative flex gap-6 sm:gap-8 p-6 sm:p-8 border border-white/[0.07] ${
              i > 0 ? "border-t-0" : ""
          ...
          >
            <div className="shrink-0">
              <div className="w-12 h-12 flex items-center justify-center border border-white/20 bg-white/[0.04] group-hover:bg-white/[0.08] group-hover:border-white/40 transition-all duration-300">
                <span className="font-medium text-[16px] font-bold text-zinc-300">{step.number}</span>
              </div>
            </div>
            <div>
  ...
  return (
    <div>
      ...
      <div className="border border-white/[0.07] overflow-hidden">
        {/* Header */}
        <div className="grid grid-cols-4 gap-4 px-5 py-3 bg-white/[0.02] border-b border-white/[0.07]">
        ...
        {categories.map((cat, i) => (
          <div
            key={cat.name}
            className={`grid grid-cols-4 gap-4 px-5 py-3.5 hover:bg-white/[0.02] transition-colors ${
...
export default function Earn() {
  return (
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 sm:py-24 border-b border-white/[0.07]">
        <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 max-w-3xl">
          <div className="border border-white/[0.07] bg-white/[0.015] p-6 sm:p-10 lg:p-12">
            ...
            <div className="grid grid-cols-2 gap-px bg-white/[0.06] mt-8">
              <div className="bg-white/[0.02] p-5 sm:p-6">
                ...
                <div className="text-[28px] sm:text-[36px] font-bold text-white/40 tracking-tight leading-none">$85B</div>
              ...
              <div className="bg-white/[0.02] p-5 sm:p-6">
                ...
                <div className="text-[28px] sm:text-[36px] font-bold text-zinc-300 tracking-tight leading-none">$110B</div>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 max-w-2xl text-center">
          <h2 className="text-[clamp(1.5rem,4vw,2.5rem)] font-bold text-white leading-[1.1] tracking-tight mb-4">
