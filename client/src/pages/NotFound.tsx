    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-lg">
          <div className="text-[120px] md:text-[160px] font-bold text-white/[0.03] leading-none select-none -mb-8">
            404
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-white/90 tracking-tight mb-3">
            Route not found.
          </h1>
          ...
          <div className="border border-white/[0.07] bg-white/[0.01] p-4 mb-8 text-left">
...
Suggestion: Try one of the following:
  ...
  → /docs`}
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <a href="/marketplace"
              className="text-sm font-medium border border-white/[0.07] text-white/35 hover:text-white/55 hover:border-white/[0.12] px-6 py-3 transition-all">
              Marketplace
            </a>
            <a href="/docs"
              className="text-sm font-medium border border-white/[0.07] text-white/35 hover:text-white/55 hover:border-white/[0.12] px-6 py-3 transition-all">
